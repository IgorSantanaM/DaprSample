...
{
    public class DaprClientStateStoreShoppingBasket(DaprClient daprClient, IEventCatalogService eventCatalogService, Settings settings, ILogger<DaprClientStateStoreShoppingBasket> logger) : IShoppingBasketService
    {
